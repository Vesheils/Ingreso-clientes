        ...
        <table id="tabla_asistencias" class="table table-bordered table-condensed table-hover responsive">
            <div class="table-title">
                <div class="row align-items-start">
                    ...
                    <div class="col-md-4 offset-md-4" style="max-width: 410px; position: relative; left:29px;">
                        <a href="logout.php" class="btn btn-danger"><i class="fa fa-sign-out"></i> Cerrar sesión</a>
                        <a href="../crud_adm/usuario/add_usr.php" class="btn btn-success"><i class="fa fa-user"></i> Usuarios</a>
                        <a href="../crud_adm/create_adm.php" class="btn btn-info"><i class="fa fa-plus"></i> Agregar cliente</a>
                    </div>
                    </div>
            </div>
            </table>
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_object($listado)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="../crud_adm/update.php?id=<?php echo $id; ?>" class="edit" title="Editar"
                                    data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                <a href="../crud_adm/delete.php?id=<?php echo $id; ?>" class="delete" title="Eliminar"
                                    data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                            </td>
                        </tr>
                    <?php } ?>
